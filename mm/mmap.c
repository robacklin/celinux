...
int sysctl_overcommit_ratio = 90;	/* default is 90% */
 ...
 *
 * Mode 2 is a strict overcommit policy set via vm.overcommit_memory.
 * See Documentation/vm/overcommit-acounting
 *
