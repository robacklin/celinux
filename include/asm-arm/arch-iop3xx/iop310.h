...
#define IOP310_AAU_ACR    (volatile u32 *)IOP310_REG_ADDR(0x00001800)
#define IOP310_AAU_ASR    (volatile u32 *)IOP310_REG_ADDR(0x00001804)
#define IOP310_AAU_ADAR   (volatile u32 *)IOP310_REG_ADDR(0x00001808)
#define IOP310_AAU_ANDAR  (volatile u32 *)IOP310_REG_ADDR(0x0000180C)
#define IOP310_AAU_SAR1   (volatile u32 *)IOP310_REG_ADDR(0x00001810)
#define IOP310_AAU_SAR2   (volatile u32 *)IOP310_REG_ADDR(0x00001814)
#define IOP310_AAU_SAR3   (volatile u32 *)IOP310_REG_ADDR(0x00001818)
#define IOP310_AAU_SAR4   (volatile u32 *)IOP310_REG_ADDR(0x0000181C)
#define IOP310_AAU_DAR    (volatile u32 *)IOP310_REG_ADDR(0x00001820)
#define IOP310_AAU_ABCR   (volatile u32 *)IOP310_REG_ADDR(0x00001824)
#define IOP310_AAU_ADCR   (volatile u32 *)IOP310_REG_ADDR(0x00001828)
#define IOP310_AAU_SAR5   (volatile u32 *)IOP310_REG_ADDR(0x0000182C)
#define IOP310_AAU_SAR6   (volatile u32 *)IOP310_REG_ADDR(0x00001830)
#define IOP310_AAU_SAR7   (volatile u32 *)IOP310_REG_ADDR(0x00001834)
#define IOP310_AAU_SAR8   (volatile u32 *)IOP310_REG_ADDR(0x00001838)
