...
#define XCHAL_ITLB_SET1_ASID_RESET		1	/* 1 if ASID reset values defined (and all writable); 0 otherwise */
#define XCHAL_ITLB_SET1_VPN_RESET		1	/* 1 if VPN reset values defined (and all writable); 0 otherwise */
#define XCHAL_ITLB_SET1_PPN_RESET		1	/* 1 if PPN reset values defined (and all writable); 0 otherwise */
#define XCHAL_ITLB_SET1_CA_RESET		1	/* 1 if CA reset values defined (and all writable); 0 otherwise */
/*  Reset ASID values for each entry of ITLB way set 1 (because SET1_ASID_RESET is non-zero):  */
#define XCHAL_ITLB_SET1_E0_ASID_RESET		0x01
#define XCHAL_ITLB_SET1_E1_ASID_RESET		0x01
#define XCHAL_ITLB_SET1_E2_ASID_RESET		0x01
#define XCHAL_ITLB_SET1_E3_ASID_RESET		0x01
/*  Reset VPN values for each entry of ITLB way set 1 (because SET1_VPN_RESET is non-zero):  */
#define XCHAL_ITLB_SET1_E0_VPN_RESET		0xCFC00000
#define XCHAL_ITLB_SET1_E1_VPN_RESET		0xCFD00000
#define XCHAL_ITLB_SET1_E2_VPN_RESET		0xCFE00000
#define XCHAL_ITLB_SET1_E3_VPN_RESET		0xCFF00000
/*  Reset PPN values for each entry of ITLB way set 1 (because SET1_PPN_RESET is non-zero):  */
#define XCHAL_ITLB_SET1_E0_PPN_RESET		0xCFC00000
#define XCHAL_ITLB_SET1_E1_PPN_RESET		0xCFD00000
#define XCHAL_ITLB_SET1_E2_PPN_RESET		0xCFE00000
#define XCHAL_ITLB_SET1_E3_PPN_RESET		0xCFF00000
/*  Reset CA values for each entry of ITLB way set 1 (because SET1_CA_RESET is non-zero):  */
#define XCHAL_ITLB_SET1_E0_CA_RESET		0x07
#define XCHAL_ITLB_SET1_E1_CA_RESET		0x07
#define XCHAL_ITLB_SET1_E2_CA_RESET		0x07
#define XCHAL_ITLB_SET1_E3_CA_RESET		0x07
...
#define XCHAL_DTLB_SET1_ASID_RESET		1	/* 1 if ASID reset values defined (and all writable); 0 otherwise */
#define XCHAL_DTLB_SET1_VPN_RESET		1	/* 1 if VPN reset values defined (and all writable); 0 otherwise */
#define XCHAL_DTLB_SET1_PPN_RESET		1	/* 1 if PPN reset values defined (and all writable); 0 otherwise */
#define XCHAL_DTLB_SET1_CA_RESET		1	/* 1 if CA reset values defined (and all writable); 0 otherwise */
/*  Reset ASID values for each entry of DTLB way set 1 (because SET1_ASID_RESET is non-zero):  */
#define XCHAL_DTLB_SET1_E0_ASID_RESET		0x01
#define XCHAL_DTLB_SET1_E1_ASID_RESET		0x01
#define XCHAL_DTLB_SET1_E2_ASID_RESET		0x01
#define XCHAL_DTLB_SET1_E3_ASID_RESET		0x01
/*  Reset VPN values for each entry of DTLB way set 1 (because SET1_VPN_RESET is non-zero):  */
#define XCHAL_DTLB_SET1_E0_VPN_RESET		0xCFC00000
#define XCHAL_DTLB_SET1_E1_VPN_RESET		0xCFD00000
#define XCHAL_DTLB_SET1_E2_VPN_RESET		0xCFE00000
#define XCHAL_DTLB_SET1_E3_VPN_RESET		0xCFF00000
/*  Reset PPN values for each entry of DTLB way set 1 (because SET1_PPN_RESET is non-zero):  */
#define XCHAL_DTLB_SET1_E0_PPN_RESET		0xCFC00000
#define XCHAL_DTLB_SET1_E1_PPN_RESET		0xCFD00000
#define XCHAL_DTLB_SET1_E2_PPN_RESET		0xCFE00000
#define XCHAL_DTLB_SET1_E3_PPN_RESET		0xCFF00000
/*  Reset CA values for each entry of DTLB way set 1 (because SET1_CA_RESET is non-zero):  */
#define XCHAL_DTLB_SET1_E0_CA_RESET		0x07
#define XCHAL_DTLB_SET1_E1_CA_RESET		0x07
#define XCHAL_DTLB_SET1_E2_CA_RESET		0x07
#define XCHAL_DTLB_SET1_E3_CA_RESET		0x07
