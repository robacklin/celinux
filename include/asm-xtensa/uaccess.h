#ifndef __ASM_XTENSA_UACCESS_H
#define __ASM_XTENSA_UACCESS_H
 ...
 * for more details.
 *
 * Copyright (C) 2001 Tensilica Inc., by Joe Taylor
 */
...
/* access_ok determines whether a memory access is allowed.  See the
   ...
   On Exit:
	...
	<at>	destroyed
*/
	.macro	access_ok  aa, as, at, error
	kernel_ok  \at, .Laccess_ok_\@
...
/* verify_area determines whether a memory access is allowed.  It's
   ...
   On Exit:
	...
	<at>	destroyed
*/
	.macro	verify_area	aa, as, at, error
	access_ok  \at, \aa, \as, \error
	.endm
 ...
 * *_zeroing equivalents for Xtensa. */
