...
#define	GT64260_PCI_MEM_BASE_ADDR_PROC	0x80000000U	/* CPU Address */
#define	GT64260_PCI_IO_BASE_ADDR_PROC	(GT64260_PCI_MEM_BASE_ADDR_PROC + \
					GT64260_PCI_0_MEM_SIZE +	  \
					GT64260_PCI_1_MEM_SIZE)

#define	GT64260_PCI_MEM_BASE_ADDR	0x80000000U	/* PCI Address */
#define	GT64260_PCI_IO_BASE_ADDR	0x00000000U

/*
 * PCI Bus 0 Definitions
 */
/* Processor Physical addresses */
#define	GT64260_PCI_0_MEM_START_PROC	GT64260_PCI_MEM_BASE_ADDR_PROC
#define	GT64260_PCI_0_MEM_END_PROC	(GT64260_PCI_0_MEM_START_PROC + \
					 GT64260_PCI_0_MEM_SIZE - 1)

/* PCI 0 MEM address */
#define	GT64260_PCI_0_MEM_START		GT64260_PCI_MEM_BASE_ADDR
#define	GT64260_PCI_0_MEM_END		(GT64260_PCI_0_MEM_START + \
					 GT64260_PCI_0_MEM_SIZE - 1)

/* Processor Physical addresses */
#define	GT64260_PCI_0_IO_START_PROC	GT64260_PCI_IO_BASE_ADDR_PROC
#define	GT64260_PCI_0_IO_END_PROC	(GT64260_PCI_0_IO_START_PROC + \
					 GT64260_PCI_0_IO_SIZE - 1)

/* PCI 0 I/O address */
#define	GT64260_PCI_0_IO_START		GT64260_PCI_IO_BASE_ADDR
 ...
 */
/* Processor Physical addresses */
#define	GT64260_PCI_1_MEM_START_PROC	(GT64260_PCI_0_MEM_END_PROC + 1)
#define	GT64260_PCI_1_MEM_END_PROC	(GT64260_PCI_1_MEM_START_PROC + \
					 GT64260_PCI_1_MEM_SIZE - 1)

/* PCI 0 MEM address */
#define	GT64260_PCI_1_MEM_START		(GT64260_PCI_0_MEM_END + 1)
#define	GT64260_PCI_1_MEM_END		(GT64260_PCI_1_MEM_START + \
					 GT64260_PCI_1_MEM_SIZE - 1)

/* Processor Physical addresses */
#define	GT64260_PCI_1_IO_START_PROC	(GT64260_PCI_0_IO_END_PROC + 1)
#define	GT64260_PCI_1_IO_END_PROC	(GT64260_PCI_1_IO_START_PROC + \
					 GT64260_PCI_1_IO_SIZE - 1)

/* PCI 0 I/O address */
#define	GT64260_PCI_1_IO_START		(GT64260_PCI_0_IO_END + 1)
...
typedef struct {
	...
	u32	cpu_prot_options[GT64260_CPU_SCS_DECODE_WINDOWS];
	u32	cpu_snoop_options[GT64260_CPU_SNOOP_WINDOWS];

	struct pci_controller	*hose_a;
	struct pci_controller	*hose_b;

	u32	pci_0_acc_cntl_options[GT64260_PCI_SCS_WINDOWS];
	u32	pci_0_snoop_options[GT64260_PCI_SNOOP_WINDOWS];
	u32	pci_0_latency;
	...
	u32	pci_1_acc_cntl_options[GT64260_PCI_SCS_WINDOWS];
	u32	pci_1_snoop_options[GT64260_PCI_SNOOP_WINDOWS];
	u32	pci_1_latency;
...
#define	GT64260_BRIDGE_INFO_DEFAULT(ip, ms) {				\
	memset((ip), 0, sizeof(gt64260_bridge_info_t));			\
									\
	(ip)->mem_size = (ms);						\
									\
...
extern inline void gt_modify(u32 offs, u32 data, u32 mask) \
{
	...
	spin_lock_irqsave(&gt64260_rmw_lock, flags);
	reg = gt_read(offs) & (~mask); /* zero any bits we care about*/
	reg |= data & mask; /* set bits from the data */
	gt_write(offs, reg);
	spin_unlock_irqrestore(&gt64260_rmw_lock, flags);
}
...
int gt64260_find_bridges(gt64260_bridge_info_t *info,
...
int gt64260_cpu_snoop_set_window(u32 window,
			         ...
			         u32 size,
			         u32  snoop_type);
void gt64260_cpu_disable_windows(void);
...
int gt64260_pci_snoop_set_window(u32 pci_bus,
			         ...
			         u32 size,
			         u32 snoop_type);
int gt64260_set_base(u32 new_phys_base);
