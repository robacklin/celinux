...
/* 
 * [jsun] For preemptible kernel, we need to include these files because many 
 * (driver) code include "interrupt.h" without including "sched.h".  In 
 * those cases compiling will fail.
 */
