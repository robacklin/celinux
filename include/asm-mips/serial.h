...
#define RC32438_SERIAL_PORT_DEFNS                 \
    { baud_base: RC32438_BASE_BAUD,               \
      iomem_base: KSEG1ADDR(RC32438_UART0_BASE),  \
      irq: RC32438_UART0_IRQ,                     \
      iomem_reg_shift: 2, io_type: SERIAL_IO_MEM, \
      flags: STD_COM_FLAGS, type: 3 },            \
    { baud_base: RC32438_BASE_BAUD,               \
      iomem_base: KSEG1ADDR(RC32438_UART1_BASE),  \
      irq: RC32438_UART1_IRQ,                     \
      iomem_reg_shift: 2, io_type: SERIAL_IO_MEM, \
      flags: STD_COM_FLAGS, type: 3 },
#else
#define RC32438_SERIAL_PORT_DEFNS
...
#define SHIMA_TCUBE_SERIAL_PORT_DEFNS                                   \
