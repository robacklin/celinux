...
#elif defined(CONFIG_SH_7751_SOLUTION_ENGINE) || defined(CONFIG_SH_RTS7751R2D)
#define PCIBIOS_MIN_IO          0x4000
#define PCIBIOS_MIN_MEM         0xFD000000

#elif defined(CONFIG_SH_KZP01)
#define PCIBIOS_MIN_IO		0x2000
...
#if defined(CONFIG_SH_RTS7751R2D) || defined(CONFIG_SH_KZP01)
...
/*
 * pci_{map,unmap}_single_page maps a kernel page to dma_addr_t. identical
