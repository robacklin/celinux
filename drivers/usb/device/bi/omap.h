 ...
 * Basic stuff
 */
#define UDC_NAME                     "TI OMAP1510 USBD"	/* Name of this UDC */
#define UDC_IRQ                      (IH2_BASE + 20)	/* General UDC interrupt */
#define UDC_SOF_IRQ                  (IH2_BASE + 29)	/* Start-of-frame interrupt for ISO trns. */
#define UDC_NONISO_IRQ               (IH2_BASE + 30)	/* Non-ISO endpoint-specific interrupt */
