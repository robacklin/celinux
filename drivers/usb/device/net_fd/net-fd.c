...
/* Data Interface Alternate 1 endpoints
 */
static __initdata struct usb_endpoint_description mdlm_alt_1_endpoints[] = {
      {bEndpointAddress:CONFIG_USBD_NET_OUT_ENDPOINT,
	      bmAttributes:BULK,
	      wMaxPacketSize:CONFIG_USBD_NET_OUT_PKTSIZE,
	      bInterval:0,
...
/* Data Interface Alternate description(s)
 */
static __initdata struct usb_alternate_description mdlm_alternate_descriptions[] = {
	{
                #if defined(CONFIG_USBD_NET_NO_STRINGS)
                        iInterface:"",
                #else
...
/* Interface description(s)
 */
static __initdata struct usb_interface_description mdlm_interfaces[] = {
	{
                #if defined(CONFIG_USBD_NET_NO_STRINGS)
                        iInterface:"",
                #else
