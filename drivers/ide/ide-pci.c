...
#define DEVID_X220     ((ide_pci_devid_t){PCI_VENDOR_ID_ATI,     PCI_DEVICE_ID_ATI_X220_IDE})
#define DEVID_X225     ((ide_pci_devid_t){PCI_VENDOR_ID_ATI,     PCI_DEVICE_ID_ATI_X225_IDE})
...
extern unsigned int pci_init_x225_ide(struct pci_dev *, const char *);
extern unsigned int pci_init_x220_ide(struct pci_dev *, const char *);
extern unsigned int ata66_x225(ide_hwif_t *);
extern unsigned int ata66_x220(ide_hwif_t *);
extern void ide_init_x225(ide_hwif_t *);
extern void ide_init_x220(ide_hwif_t *);
extern void ide_dmacapable_x225(ide_hwif_t *, unsigned long);
extern void ide_dmacapable_x220(ide_hwif_t *, unsigned long);
#define PCI_X225       &pci_init_x225_ide
#define PCI_X220       &pci_init_x220_ide
#define ATA66_X225  &ata66_x225
#define ATA66_X220  &ata66_x220
#define INIT_X225      &ide_init_x225
#define INIT_X220      &ide_init_x220
#define DMA_X225       &ide_dmacapable_x225
#define DMA_X220       &ide_dmacapable_x220
#else
#define PCI_X225       NULL
#define PCI_X220       NULL
#define ATA66_X225     NULL
#define ATA66_X220     NULL
#define INIT_X225      NULL
#define INIT_X220      NULL
#define DMA_X225       NULL
#define DMA_X220       NULL
#endif
...
static ide_pci_device_t ide_pci_chipsets[] __initdata = {
	...
	{DEVID_X220, "X220",            PCI_X220,       ATA66_X220,  INIT_X220,
	   DMA_X220, {{0x00,0x00,0x00}, {0x00,0x00,0x00}},   ON_BOARD,       0 },
	{DEVID_X225 , "X225",            PCI_X225,      ATA66_X225,  INIT_X225,
	   DMA_X225, {{0x00,0x00,0x00}, {0x00,0x00,0x00}},   ON_BOARD,       0 },
...
controller_ok:			
		if (IDE_PCI_DEVID_EQ(d->devid, DEVID_HPT366) && (port) && (class_rev < 0x03))
			return;
		if (IDE_PCI_DEVID_EQ(d->devid, DEVID_X220) && (port))   /* no second port */
			return;
		/* ??? */
		if (IDE_PCI_DEVID_EQ(d->devid, DEVID_X225) && (port))   /* no second port */
			return;
