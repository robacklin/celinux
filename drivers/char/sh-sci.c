/* $Id: sh-sci.c,v 1.1.1.1.2.4 2002/09/26 01:30:11 gniibe Exp $
 *
...
#if defined(__sh3__)
/* For SH7300, SH7707, SH7709, SH7709A, SH7729, SH7727 */
static void sci_init_pins_scif(struct sci_port* port, unsigned int cflag)
{
	unsigned int fcr_val = 0;

#if defined(CONFIG_SH_SOLUTION_ENGINE) && !defined(CONFIG_CPU_SUBTYPE_SH7300)
	{
		unsigned short data;
...
#if defined(CONFIG_CPU_SUBTYPE_SH7750) ||defined(CONFIG_CPU_SUBTYPE_SH7750R) || defined(CONFIG_CPU_SUBTYPE_ST40STB1)
...
{
#if defined(CONFIG_CPU_SUBTYPE_SH7290)
	if (request_irq(port->irqs[0], sci_rx_interrupt, SA_INTERRUPT,
			"sci", port)) {
