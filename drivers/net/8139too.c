...
#define PCI_VENDOR_ID_RTL       0x10ec
#define PCI_DEVICE_ID_RTL_8139  0x8139
...
static void rtl8139_ldm_register(void);
static void rtl8139_ldm_unregister(void);
...
static int rtl8139_ldm_suspend(struct device * dev, u32 state, u32 level);
static int rtl8139_ldm_resume(struct device * dev, u32 level);

static struct device_driver rtl8139_driver_ldm = {
       name:      	"RTL8139_Drv",
       devclass:  	NULL,
       probe:     	NULL,
       suspend:   	rtl8139_ldm_suspend,
       resume:    	rtl8139_ldm_resume,
       scale:	  	NULL,
       remove:    	NULL,
       constraints:	NULL,
};

static struct device rtl8139_device_ldm = {
       name:		"rtl8139_dev ",
       bus_id:		"rtl8139",
       driver: 		NULL,
...
static void rtl8139_ldm_register(void)
{
	...
	pci_driver_ldm_register(&rtl8139_driver_ldm);
	pci_device_ldm_register(&rtl8139_device_ldm);
}
...
static void rtl8139_ldm_unregister(void)
{
	...
	pci_driver_ldm_unregister(&rtl8139_driver_ldm);
	pci_device_ldm_unregister(&rtl8139_device_ldm);
}
...
static int rtl8139_ldm_suspend(struct device * dev, u32 state, u32 level)
{
  ...
  { 
     case SUSPEND_POWER_DOWN:
       ...
       pcidevice = pci_find_device(PCI_VENDOR_ID_RTL,
				   PCI_DEVICE_ID_RTL_8139,
				   NULL);
       ret = rtl8139_suspend(pcidevice, state);
       break;
  }
