/*
 * Philips UDA1341 Audio Device Driver for S3C2440 Linux
 *
...
static ssize_t smdk2440_audio_read(struct file *file, char *buffer, 
                                        size_t count, loff_t * ppos)
{
	return 0;
}
...
void __exit s3c2440_uda1341_exit(void)
{
