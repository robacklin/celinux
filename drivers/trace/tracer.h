...
#define TRACER_NAME_U    "tracerU"    /* Name of the device as seen in /proc/devices */
...
#define TRACER_VERSION_EXTRA    4               /* Extra version number */
typedef struct _trace_start
{
  ...
  uint8_t            ExtraVersion; /* Extra version of trace */
...
{
  uint8_t            Size;  /* Size of this event, in bytes */
...
#if defined(__s390__) || defined(__mips__) || defined(CONFIG_SUPERH)
