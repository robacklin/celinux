...
extern int s3c2440fb_init(void);
...
extern int chips69000_init(void);
...
extern int necravinefb_init(void);
extern int necravinefb_setup(char*);
extern int lynx3dmfb_init(void);
extern int lynx3dmfb_setup(char*);
...
#ifdef CONFIG_FB_S3C2440
	{ "s3c2440", s3c2440fb_init, NULL },
#endif
...
#endif
#ifdef CONFIG_FB_CT69000
	{ "chips69000fb", chips69000_init, NULL },
#endif
...
#endif
#ifdef CONFIG_FB_NECRAVINE
	{ "necravinefb", necravinefb_init, necravinefb_setup },
#endif 
#ifdef CONFIG_FB_LYNX3DM
	{ "lynx3dm", lynx3dmfb_init, lynx3dmfb_setup },
#endif 
