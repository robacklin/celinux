...
struct e1356fb_fix {
	...
	int clki3;        // CLKI3 frequency, in KHz (13806 only)
...
static struct {
	 ...
	 */
	{
		{   // fix
			...
			40000, 14318, 0, // CLKI, CLKI2, CLKI3
#ifdef CONFIG_E1356_CRT
			DISP_TYPE_CRT,
			0, 0, // TV Options
			0, 0, // Panel options
#elif defined (CONFIG_E1356_NTSC)
			DISP_TYPE_NTSC,
			TV_FILT_FLICKER|TV_FILT_LUM|TV_FILT_CHROM,
			TV_FMT_COMPOSITE,
			0, 0, // Panel options
#elif defined (CONFIG_E1356_TFT)
			DISP_TYPE_TFT,
			0, 0, // TV Options
			0, 12, // Panel options, EL panel?, data width?
#elif defined (CONFIG_E1356_PAL)
			DISP_TYPE_PAL,
			TV_FILT_FLICKER|TV_FILT_LUM|TV_FILT_CHROM,
			TV_FMT_COMPOSITE,
			0, 0, // Panel options
	 ...
	 */
	{
		{   // fix
			...
			0, 12, // Panel options, EL panel?, data width?
#else
#error CRT or TFT displays only on PB1500
#endif
			0, 0,
#ifdef CONFIG_MTRR
			0,
	 ...
	 */
	{
		{   // fix
			...
			60, MEM_TYPE_EDO_2CAS, 64, MEM_SMR_CBR,
			33000, 0, 40000, 25175, 0, // BUSCLK, CLKI's
			DISP_TYPE_CRT,
			0, 0,
			0, 0,
			0, 0,
	...
	/*
	 * Hitachi SolitionEngine, MS13806DB01/1(SED1356)
	 */
	{
		{   // fix
		        SYS_SUPERH,
			0xa8000000, 0xa8200000,
			60, MEM_TYPE_EMBEDDED_SDRAM, 64, MEM_SMR_CBR,
			60000, 0,   // BUSCLK (MCLK calculated)
			80000, 25175, 50000, // CLKI, CLKI2, CLKI3
#ifdef CONFIG_E1356_CRT
			DISP_TYPE_CRT,
			0, 0, // TV Options
			0, 0, // Panel options
			...
			/* 
			 * If using accel, scrolling does not work well
			 * in SH7709s.
			 */
			1,
#else
		...
		{   // par
			640, 480, 640, 480, 16, 2,
			{25000,25000,30,50000,2,2}, 
			160, 45,
			0, 14, 96, 31250, 
			0, 12, 2, 59,
			16
