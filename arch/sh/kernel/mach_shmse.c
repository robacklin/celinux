...
void shmse_rtc_gettimeofday(struct timeval*);
int  shmse_rtc_settimeofday(const struct timeval*);
...
#endif
	mv_rtc_gettimeofday:	shmse_rtc_gettimeofday,
	mv_rtc_settimeofday:	shmse_rtc_settimeofday,
