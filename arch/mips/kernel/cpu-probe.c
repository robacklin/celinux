...
#if 0 /* disabled until fix r39xx_wait fn */
...
/*	case CPU_20KC:*/
	...
	case CPU_AU1500:
		...
		/*
		 * the wait instruction works on the RC32355, but causes
		 * a system freeze on the RC32334 - don't know why yet,
		 * so temporarily only enable for RC32355.
		 */
	case CPU_RC32300:
		cpu_wait = r4k_wait;
		printk(" available.\n");
