...
static char* default_argv[] = { "", CONFIG_CMDLINE, 0 };
...
void __init setup_arch(char **cmdline_p)
{
	...
	void idt_setup(void);
	void xilleon_setup(void);
	void shima_tcube_setup(void);
	...
	case MACH_GROUP_SIBYTE:
        ...
        case MACH_GROUP_HP_LJ:
                ...
                break;
#endif
#if defined(CONFIG_IDT_79S334) || defined(CONFIG_IDT_79EB355) || defined(CONFIG_IDT_79RP355) || defined (CONFIG_IDT_79EB438)
	case MACH_GROUP_IDT:
		idt_setup();
		break;
#endif
