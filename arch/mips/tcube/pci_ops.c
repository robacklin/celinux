...
struct pci_config_swap ext_pci_swap = {
	PADR_EPCIW1,  
	EPCI_INIT1,
	0x19800000,		// DDB_PCI0_CONFIG_BASE
	0x00800000		// DDB_PCI0_CONFIG_SIZE
};
struct pci_config_swap io_pci_swap = {
	PADR_IOPCIW0,  
	IPCI_INIT0,
	0x1A000000,		// DDB_PCI1_CONFIG_BASE
	0x00800000		// DDB_PCI1_CONFIG_SIZE
};
					 ...
					 u32 slot_num)
{
	...
	//ddb_set_pmr(swap->pmr, DDB_PCICMD_CFG, pciinit_offset, option);
        ddb_out32(swap->pmr, 
        	(DDB_PCICMD_CFG << 1) | (pciinit_offset & 0xffe00000) | option );
