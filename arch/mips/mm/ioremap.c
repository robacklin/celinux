	...
	phys_t size, phys_t phys_addr, unsigned long flags)
{
	phys_t end;
	pgprot_t pgprot =
		__pgprot(_PAGE_GLOBAL | _PAGE_PRESENT | __READABLE | flags);
...
static void * __local_ioremap(phys_t phys_addr, phys_t size,
			      unsigned long flags)
{
...
{
       return __local_ioremap(phys_addr, size, flags | __WRITEABLE);
}

void * __ioremap_readonly(phys_t phys_addr, phys_t size, unsigned long flags)
{
       return __local_ioremap(phys_addr, size, flags & ~__WRITEABLE);
}
