...
static int c_show(struct seq_file *m, void *v)
{
	...
	seq_printf(m, "ID (register 0)\t: 0x%08x\n", i);
	seq_printf(m, "Implementor\t: %x\n"
		"arch\t\t: %x\n"
		"part\t\t: %x\n"
		"rev\t\t: %x\n",
		(i >> 24) & 0xff,
	...
	asm("mrc p15, 0, %0, c1, c0, 1" : "=r" (i));
	seq_printf(m, "Control reg\t: 0x%08x\n", i);
	seq_printf(m, "mmu\t\t: %d\n"
		"align\t\t: %d\n"
		"dcache\t\t: %d\n"
		"wb\t\t: %d\n"
        ...
        asm("mrc p15, 0, %0, c15, c1, 0" : "=r" (i));
        seq_printf(m, "TI Config\t: 0x%08x\n", i);
        seq_printf(m, "lock\t\t: %d\n"
		"transparent\t: %d\n"
		"dcache flush\t: %d\n"
		"OS\t\t: %s\n"
		"nonstreaming\t: %d\n",
                     i&0x1,(i>>1)&0x1,(i>>4)&0x1,
                     ((i>>5)&0x1)?"ARM915":"ARM925",(i>>7)&0x1);
#endif
