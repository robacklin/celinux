 ...
 */
void *__consistent_alloc(int gfp, size_t size, dma_addr_t *dma_handle,
...
void *pci_alloc_consistent(struct pci_dev *hwdev, size_t size, dma_addr_t *handle)
{
	...
	/*
	 * IXP425 always needs GFP_DMA for PCI devices.  
	 * TODO: Kill this and provide an arch-hook for setting dma_mask
	 *       on all the devices.
	 */
