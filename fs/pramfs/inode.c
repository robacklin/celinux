...
static int pram_prepare_write(struct file *file,
			       struct page *page,
			       unsigned from,
			       unsigned to)
{
...
static int pram_direct_IO(int rw, struct inode * inode,
			   struct kiobuf * iobuf,
...
static int pram_sync_page(struct page *page)
{
	return 0;
}

static int pram_commit_write(struct file *file,
			      struct page *page,
...
struct address_space_operations pram_aops = {
	...
	sync_page: pram_sync_page,
	prepare_write: pram_prepare_write,
	commit_write: pram_commit_write,
	bmap: pram_bmap,
