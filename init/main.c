...
/* Round the value and print it */	
	...
	printk("Use 'Preset loops_per_jiffy'=%lu for preset lpj.\n",
		loops_per_jiffy);
#endif /* CONFIG_USE_PRESET_LPJ */
}
...
#if defined(CONFIG_OMAP_INNOVATOR) || defined(CONFIG_405LP) || defined(CONFIG_MIPS_ITE8172) || defined(CONFIG_S3C2440_SMDK2440)/* linux-pm */
	{
		extern void sysfs_init(void);
		extern void driver_init(void);
		extern void innovator_ldm_setup(void);
		extern void ocp_ldm_init();
		extern void it8172_ldm_init(void); 
		extern void s3c2440_ldm_setup(void);
		...
		ocp_ldm_init();
#endif
#if defined(CONFIG_MIPS_ITE8172)
                it8172_ldm_init();
#endif		
