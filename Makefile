...
MRPROPER_FILES = \
	...
	scripts/mkconfigs kernel/configs.c \
	kernel.spec
...
include/config/MARKER: scripts/split-include scripts/mkconfigs include/linux/autoconf.h
	scripts/split-include include/linux/autoconf.h include/config
	@ touch include/config/MARKER
	@ scripts/mkconfigs .config kernel/configs.c
...
#
# Generate a C file based on the .config
#
